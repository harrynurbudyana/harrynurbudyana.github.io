...
function Event() {
    return (
        <div className='min-h-screen bg-transparent py-20 px-3'>
            <div className='flex flex-col justify-center max-w-2xl mx-auto bg-white shadow-xl rounded-xl py-12 px-12'>
                ...
                <a href='https://maps.app.goo.gl/nqu5oVgxrNs93Ud1A' target='_blank' rel='noreferrer'>
                    <button className='bg-brown-50 hover:bg-brown-100 text-white font-bold py-2 px-4 rounded'>Buka Maps</button>
                </a>
                ...
                <div className='text-md text-center mt-3 mb-7 font-normal leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-stone-200 to-yellow-100 '>
                    ...
                    <p className='flex space-x-4 justify-center mx-auto text-yellow-100'>
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="head-side-mask" className="svg-inline--fas fa-hands-wash w-9 h-9 mt-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M.15,184.42C-2.17,244.21,23,298.06,64,334.88V512H224V316.51L3.67,156.25A182.28,182.28,0,0,0,.15,184.42ZM509.22,275c-21-47.12-48.5-151.75-73.12-186.75A208.11,208.11,0,0,0,266.11,0H200C117,0,42.48,50.57,13.25,123.65L239.21,288H511.76A31.35,31.35,0,0,0,509.22,275ZM320,224a32,32,0,1,1,32-32A32.07,32.07,0,0,1,320,224Zm16,144H496l16-48H256V512H401.88a64,64,0,0,0,60.71-43.76L464,464H336a16,16,0,0,1,0-32H474.67l10.67-32H336a16,16,0,0,1,0-32Z"></path></svg>
                        ...
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="people-arrows" className="svg-inline--fa fa-people-arrows fa-w-18 w-10 h-10 mt-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M96,128A64,64,0,1,0,32,64,64,64,0,0,0,96,128Zm0,176.08a44.11,44.11,0,0,1,13.64-32L181.77,204c1.65-1.55,3.77-2.31,5.61-3.57A63.91,63.91,0,0,0,128,160H64A64,64,0,0,0,0,224v96a32,32,0,0,0,32,32V480a32,32,0,0,0,32,32h64a32,32,0,0,0,32-32V383.61l-50.36-47.53A44.08,44.08,0,0,1,96,304.08ZM480,128a64,64,0,1,0-64-64A64,64,0,0,0,480,128Zm32,32H448a63.91,63.91,0,0,0-59.38,40.42c1.84,1.27,4,2,5.62,3.59l72.12,68.06a44.37,44.37,0,0,1,0,64L416,383.62V480a32,32,0,0,0,32,32h64a32,32,0,0,0,32-32V352a32,32,0,0,0,32-32V224A64,64,0,0,0,512,160ZM444.4,295.34l-72.12-68.06A12,12,0,0,0,352,236v36H224V236a12,12,0,0,0-20.28-8.73L131.6,295.34a12.4,12.4,0,0,0,0,17.47l72.12,68.07A12,12,0,0,0,224,372.14V336H352v36.14a12,12,0,0,0,20.28,8.74l72.12-68.07A12.4,12.4,0,0,0,444.4,295.34Z"></path></svg>

                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="handshake-slash" className="svg-inline--fa fa-handshake-slash fa-w-20 w-10 h-10 mt-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M0,128.21V384H64a32,32,0,0,0,32-32V184L23.83,128.21ZM48,320.1a16,16,0,1,1-16,16A16,16,0,0,1,48,320.1Zm80,31.81h18.3l90.5,81.89a64,64,0,0,0,90-9.3l.2-.2,17.91,15.5a37.16,37.16,0,0,0,52.29-5.39l8.8-10.82L128,208.72Zm416-223.7V352.1a32,32,0,0,0,32,32h64V128.21ZM592,352.1a16,16,0,1,1,16-16A16,16,0,0,1,592,352.1ZM303.33,202.67l59.58-54.57a16,16,0,0,1,21.59,23.61L358.41,195.6,504,313.8a73.08,73.08,0,0,1,7.91,7.7V128L457.3,73.41A31.76,31.76,0,0,0,434.7,64H348.8a31.93,31.93,0,0,0-21.6,8.41l-88.07,80.64-25.64-19.81L289.09,64H205.3a32,32,0,0,0-22.6,9.41L162.36,93.72,45.47,3.38A16,16,0,0,0,23,6.19L3.38,31.46A16,16,0,0,0,6.19,53.91L594.53,508.63A16,16,0,0,0,617,505.82l19.65-25.27a16,16,0,0,0-2.82-22.45Z"></path></svg>
                    </p>
                </div>
                ...
                <div className='mb-8'>               
                    ...
                    <p className='bg-clip-text text-md font-bold text-transparent bg-gradient-to-r from-pink-700 to-white'>Kel. Bpk Hudri - Ibu Heni
                        <span>&</span><span>Bpk Thuryana - Ibu Nurelah</span>
                    </p>
                </div>
            </div>
            </div>
