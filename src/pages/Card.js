    ...
    return (
        <div className='min-h-screen bg-transparent py-20 px-3'>
            ...
            <div className='bg-white-700 text-sm text-white text-center inset-x-0 bottom-0 p-9'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-arrow-down-circle mx-auto mt-2 animate-bounce" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
