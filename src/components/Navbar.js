    ...
    return (
            <div>
                ...
                <nav className='fixed bottom-10 rounded-lg inset-x-6 bg-blue-600 flex justify-between text-sm text-black-800 uppercase font-semibold'>
                    ...
                    <Link to="/home" className="w-full block py-5 px-3 text-center hover:bg-black-200 hover:text-white transition duration-300">
                    ...
                    <Link to="/couple" className="w-full block py-5 px-3 text-center hover:bg-black-200 hover:text-white transition duration-300">
                    ...
                    <Link to="/event" className="w-full block py-5 px-3 text-center hover:bg-black-200 hover:text-white transition duration-300">
                    ...
                    <Link to="/gallery" className="w-full block py-5 px-3 text-center hover:bg-black-200 hover:text-white transition duration-300">
